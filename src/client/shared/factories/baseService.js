    ...
    .factory('baseService', function($http, $q, ENV) {
        ...
        var baseServiceFactory = {
            ...
            getPath: function(uri, params) {
                var url = ENV.urlbase + baseServiceFactory.encode(uri);
                if (params) {
                    url += "?" + $.param(params);
                }
                return url;
            ...
            get: function(uri, params) {
                ...
                if (params) {
                    ...
                    promise = $http.get(ENV.urlbase + baseServiceFactory.encode(uri), {
                        params: tmpParams
                    });
                } else {
                    promise = $http.get(ENV.urlbase + baseServiceFactory.encode(uri));
            ...
            delete: function(uri, params) {
                ...
                if (params) {
                    ...
                    promise = $http.delete(ENV.urlbase + baseServiceFactory.encode(uri), {
                        params: tmpParams
                    });
                } else {
                    promise = $http.delete(ENV.urlbase + baseServiceFactory.encode(uri));
            ...
            save: function(uri, data, id, useJson) {
                ...
                return $http[method](ENV.urlbase + baseServiceFactory.encode(uri), useJson ? tmpData : $.param(tmpData), {
                    headers: {
            ...
            saveAll: function(uri, data) {
                ...
                return $http.post(ENV.urlbase + baseServiceFactory.encode(uri), $.param(tmpData), {
                    headers: {
